    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-600">Track your wellness journey and stay informed</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <div>
                    <div className="card">
                        ...
                        {riskData?.risk ? (
                            <div>
                                <div className={`inline-block px-4 py-2 rounded-full font-semibold ${riskData.risk.riskLevel === 'LOW' ? 'bg-green-100 text-green-700' :
                                    riskData.risk.riskLevel === 'MODERATE' ? 'bg-orange-100 text-orange-700' :
                                        'bg-red-100 text-red-700'
                                    }`}>
                                    {riskData.risk.riskLevel}
                                </div>
                                <p className="text-sm text-gray-600 mt-3">
                                    Last calculated {new Date(riskData.risk.calculatedAt).toLocaleDateString()}
                                </p>
                            </div>
                        ) : (
                            <p className="text-sm text-gray-600">Log cycle data to see risk assessment</p>
                        )}
                    </div>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                <div className="card">
                    ...
                    <p className="text-sm text-gray-600 mb-4">Log your menstrual cycles and view patterns</p>
                    <Link to="/user/cycle" className="text-soft-pink-600 hover:text-soft-pink-700 text-sm font-medium">
                        Track Now →
                    </Link>
                </div>
                <div className="card">
                    ...
                    <p className="text-sm text-gray-600 mb-4">Monitor symptoms and understand patterns</p>
                    <Link to="/user/symptoms" className="text-sage-600 hover:text-sage-700 text-sm font-medium">
                        Log Symptoms →
                    </Link>
                </div>
                <div className="card">
                    ...
                    <p className="text-sm text-gray-600 mb-4">View your PCOS risk with explanations</p>
                    <Link to="/user/risk" className="text-warm-beige-700 hover:text-warm-beige-800 text-sm font-medium">
                        View Report →
                    </Link>
                </div>
            </div>
                ...
                <header className="bg-white border-b border-gray-200 p-4 md:p-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <h1 className="text-2xl font-bold text-gray-800">PCOS Wellness</h1>
                        </div>
                    </div>
                </header>
